...
class Productview(View):
     def get(self, request):
          ...
          return render(request, 'Shop/home.html', {'gentpants':gentpants, 'borkas': borkas, 'babyfashions':babyfashions})
...
def address(request):
  ...
  return render(request, 'Shop/address.html',{'addres':addres,'active':'btn-outline-danger'})
...
def Saree(request, data = None):
     ...
     return render(request, 'Shop/sarees.html', {'saree': saree})
...
def Borkha(request, data = None):
     ...
     return render(request, 'Shop/borkhas.html', {'borkha':borkha})
...
def Gents_Pants(request, data = None):
     ...
     return render(request, 'Shop/gents_Pant.html', {'gents_Pant': gents_Pant})
...
def orders(request):
 ...
 return render(request, 'Shop/orders.html', {'order_place':order_place})
    ...
    if request.user.is_authenticated:
        ...
        if  card_amount:
             for p in card_amount:
                ...
                amount += temproraryamount
                total_cost = amount + shoppimg_amount
             return render(request, 'Shop/addtocart.html',{'card':card, 'amount':amount, 'total_cost':total_cost})
        else:
